...
function Quiz() {
    ...
    useEffect(() => {
        ...
        time <= 10 ? setIsErrorMessage(true) : setIsErrorMessage(false);
        if (time < 0) {
            nextQuestion(null);
        }
        ...
        <div>
            <div className="progress-box">
                <div className="progress-top">
                    <div className="progress-texts">
                        ...
                        <p className="progress-description">You are solving {level} Level words quiz</p>
                    </div>
                </div>
                <div className="progress-bottom">
                    <div
                        ...
                        aria-valuemax="100"
                        style={{
                            '--value': ((currentQuestion + 1) / questions[level].length) * 100,
                        }}
                    >
                    ...
                    <p className="progress-detail">
                        You solve the {currentQuestion + 1}. question out of a total of {questions[level].length}{' '}
                        questions
                    </p>
                </div>
            </div>
            <div className="question-box">
                <div className="question-text">
                    ...
                    <h3 className="question">{questions[level][currentQuestion].question}</h3>
                </div>
                <div
            ...
            {isNextButton ? (
                <div className="next">
                    <button onClick={() => nextQuestion(selectedIndex)} type="button" className="next-btn">
                        Next Question
