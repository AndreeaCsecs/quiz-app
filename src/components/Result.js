...
function Result() {
    ...
    return (
        <div className="result">
            ...
            <h2 className="check-answers-title">Check your answers</h2>
                ...
                {allQuestions.map((item, key) => {
                    ...
                    return (
                        <div
                            key={key}
                            className={
                                allAnswers[key].trueAnswer ? 'check-answer-box correct' : 'check-answer-box wrong'
                            }
                        >
                            <div className="check-answer-top">
                                ...
                                <div className="check-icon">{allAnswers[key].trueAnswer ? '🥳' : '😢'}</div>
                            </div>
